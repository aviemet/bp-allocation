...
- Embedded schemas (used within other schemas) should not have `_id` fields in generated types
...
The application supports two modes of chit voting controlled by `PresentationSettings.useKioskChitVoting`:
