...
import { type ButtonProps, Paper } from '@mui/material'
...
interface ISendWithFeedbackButtonProps extends ButtonProps {
	message: string
	members: Member[]
}

const SendWithFeedbackButton = observer(({ message, members, ...rest }: ISendWithFeedbackButtonProps) => {
