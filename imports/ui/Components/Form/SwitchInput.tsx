...
import { Controller, type EventType, useFormContext, type UseFormSetValue, type FieldValues } from 'react-hook-form'
import { FormControlLabel, Switch } from '@mui/material'

interface ICheckboxInputProps {
	name: string
	label: string
	onUpdate?: (value: {[x: string]: any}, watchName: string|undefined, setValue: UseFormSetValue<FieldValues>) => void
}
