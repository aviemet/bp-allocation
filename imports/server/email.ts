...
const htmlEmailWrapper = (message: string) => `<html><head><style> 
	img { 
...
const messageBuilder = (memberCode: string, body: string, slug: string, includeLink: boolean) => {
